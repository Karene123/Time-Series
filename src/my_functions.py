...
def load_check_merge(csv_paths, how="outer"):
    all_dfs = []
    missing_report = {}
    ...
    for path in csv_paths:
        ...
        if len(missing) == 0:
            ...
            print(" Missing values have been detected")
            print(missing)

        missing_report[path] = missing
        all_dfs.append(df)
    ...
    for i in range(1, len(all_dfs)):
        ...
        merged_df = merged_df.merge(all_dfs[i], on='observation_date', how=how)

    return merged_df, missing_report
