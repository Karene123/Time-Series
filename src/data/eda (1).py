...
Original file is located at
    https://colab.research.google.com/drive/1m3EP0ThYuD8RvqXXr62DjFSv3piSnURh
...
# Response Variable
CPI_df = pd.read_excel('data/raw/CPIAUCSL(1).xlsx') #CPI for all urban customers
print(CPI_df)
...
M2V_df = pd.read_excel('data/raw/M2V(1).xlsx')
...
# All the missing rows from M2V and GDPC1 were replaced using linear interpolation
print(data_sliced)
